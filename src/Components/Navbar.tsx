...
const Navbar = () => {
    ...
    return (
        <nav className='relative container mx-auto pt-6 pb-6 lg:w-[80%] '>
            <div className='flex items-center justify-between'>
                ...
                <div className='hidden  md:flex flex-1 justify-between space-x-10 '>
                    ...
                    <div className='relative'>
                        ...
                        <div className="absolute hidden peer-hover:flex hover:flex w-[200px] flex-col pt-4 drop-shadow-lg" >
                            <div className='mt-0 bg-neutral-400/50 text-white absolute -left-3 pl-3 pb-6 pt-3 rounded'>
                                <div className='absolute -top-[0.65rem] left-3 w-0 h-0 border-l-[0.6rem] border-l-transparent border-b-[0.7rem] border-b-neutral-400/50 border-r-[0.5rem] border-r-transparent'></div>
