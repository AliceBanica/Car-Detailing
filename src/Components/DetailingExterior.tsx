            ...
            <div className=' h-screen w-full bg-interior-img bg-no-repeat bg-cover z-[-1]'>
                <div className='flex justify-center content-center h-full lg:pt-0'>
                    <div className='flex flex-col justify-evenly content-center md:grid md:grid-cols-2 md:gap-y-[2rem] md:gap-x-[7rem] md:place-content-center w-full h-full lg:w-[80%] xl:w-[60%] mx-auto  text-white'>
                        ...
                        <div id='int-intro-photo'><img className='w-[80%] sm:w-[60%] md:w-[80%] xl:w-[100%] h-[10rem] sm:h-[15rem] md:h-[20rem] xl:h-[22rem] sm:pt-[2rem] ml-[10%] sm:ml-[20%] md:ml-[10%] xl:ml-[0] rounded' src={headlight} alt="" /></div>
                        <div id='int-intro-photo'><img className='w-[80%] sm:w-[60%] md:w-[80%] xl:w-[100%] h-[10rem] sm:h-[15rem] md:h-[20rem] xl:h-[22rem] sm:pt-[2rem] ml-[10%] sm:ml-[20%] md:ml-[10%] xl:ml-[0] rounded-[1rem]' src={carExt} alt="" /></div>
                    </div>
                </div>
            </div>
            <div className='w-full h-screen bg-red-100 '>
                <div className='flex flex-col  content-center h-full  lg:w-[80%] xl:w-[60%] mx-auto'>
                    <div className='relative flex flex-col-reverse  h-[60rem] md:h-[80rem] border-2 border-blue-600'>
                        <div className='absolute w-full h-full -right-[10rem] top-[12rem] int-right md:top-0 md:w-[50%] md:pt-[10rem]'>
                        ...
                        <div className='absolute w-full h-full -left-[10rem] top-[4rem] int-left md:top-0 md:w-[50%] md:pt-[10rem]'>
                    ...
                    <div className='relative flex flex-col md:flex-row h-[60rem] md:h-[80rem]  border-2 border-green-600'>


                        <div className='absolute w-full h-full -left-[10rem] top-[2rem] int-left md:top-0 md:w-[50%] md:pt-[10rem]  md:right-0 '>
                            <div className='flex flex-1 flex-col justify-center mt-[2rem] ml-[5%] mr-[5%]'>
                        ...
                        <div className='absolute w-full h-full -right-[10rem]  top-[11rem]  int-right  md:top-0 md:w-[50%]  md:pt-[10rem]'>
                            <div className='flex flex-1 flex-row ml-[10%] md:ml-[5%] md:mr-[5%] mt-[2rem] md:mt-0'>
                                <div className='h-[10rem] md:h-[15rem] lg:h-[18rem] w-[45%] md:w-[100%] border-2 border-red-600'>BEFORE</div>
                                <div className='h-[10rem] md:h-[15rem] lg:h-[18rem] w-[45%] md:w-[100%] border-2 border-red-600'>AFTER</div>
                            </div>
