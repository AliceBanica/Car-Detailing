        ...
        <section className="absolute top-0 h-screen w-full bg-home-img bg-no-repeat bg-cover overflow-hidden z-[-1]">
            <div className='relative flex flex-col top-[30%] left-[20%] w-[60%] md:top-[30%] lg:w-[40%] lg:left-[50%] text-white'>
                <div className='absolute -left-[10rem] h-screen w-full' id="home">
                    ...
                    <p className='text-justify text-[1.1rem] md:text-[1.5rem]'>Interior sau exterior, oferim servicii de ingrijire ale masinii, realizate cu echipament profesional, indiferent de marca sau model. Facem eforturi pentru a ne asigura ca oferim cele mai bune servicii de ingrijire ale masinii dumneavoastra.</p>
